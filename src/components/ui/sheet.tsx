...
>(({ side = "right", className, children, container, overlayClassName, ...props }, ref) => (
  <SheetPortal container={container}>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-3 top-3 inline-flex h-11 w-11 items-center justify-center rounded-full text-[#6F6F69] opacity-80 ring-offset-background transition-opacity hover:opacity-100 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none lg:right-4 lg:top-4 lg:h-8 lg:w-8">
        <X className="h-4 w-4" />
